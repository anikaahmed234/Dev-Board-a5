window.onload = function () {
  ...
  const previouslyCompletedTaskCount = 0;
  ...
  const taskAssignedCountElement = document.getElementById(
    "task-assigned-count"
  );
  ...
  document.querySelectorAll(".task-info").forEach(function (taskInfo) {
    ...
    completeButton.addEventListener("click", function () {
      ...
      totalTasksElement.innerText =
        previouslyCompletedTaskCount + completedTasksCount;
    });
  });
  ...
  document
    .getElementById("clear-activity-history-btn")
